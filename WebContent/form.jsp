	                ...
	                <div class="card-body">
	                 ...
	                 <!--       <div class="input-group">
	                        ...
	                        <div class="row row-space">
	                            <div class="col-2">
	                                <div class="input-group">
	                                    <input class="input--style-2" type="text" placeholder="Nom" name="NomFr">
	                                    
	                                </div>
	                        </div>
	                            <div class="col-2">
	                                <div class="input-group">
	                                <input class="input--style-2" type="text" placeholder="Prenom" name="PrenomFr">
	                                  </div>
	                            </div>
	                        </div>
	                        ...
	                        <div class="row row-space">
	                            <div class="col-2">
	                                <div class="input-group">
	                                    <input class="input--style-2" type="text" placeholder="الاسم عائلي " name="NomAr">
	                                    
	                                </div>
	                        </div>
	                            <div class="col-2">
	                                <div class="input-group">
	                                <input class="input--style-2" type="text" placeholder="الاسم الشخصي"" name="PrenomAr">
	                                  </div>
	                            </div>
	                        </div>
	...
	<!-- class="input--style-2 js-datepicker" -->
	                         ...
	                         <div class="input-group">
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="lieuN_fr">
	                                            <option disabled="disabled" selected="selected">Lieu de naissance</option>
	              ...
	              <option value="Zimbabwe"> Zimbabwe </option>
	                            ...
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="lieuN_ar">
	                                            <option disabled="disabled" selected="selected"> مكان الولادة</option>
	                        ...
	                        <div class="input-group">
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="villeNaissance">
	                                            <option disabled="disabled" selected="selected">Ville de naissance</option>
	                      ...
	                      <div class="input-group">
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="nationalite">
	                                            <option disabled="disabled" selected="selected">  Nationnalité</option>
	              ...
	              <option value="Autres"> Autres </option>
	                        ...
	                        <div class="row row-space">
	                            ...
	                            <div class="col-2">
	                                <div class="input-group">
	                                <input class="input--style-2" type="text" placeholder="Code massar" name="massarEtud">
	                                  </div>
	                            </div>
	                        </div>
	            ...
	            <div class="input-group">
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="sBac">
	                                            <option disabled="disabled" selected="selected">Serie Bac </option>
	              ...
	              <option value="Sciences et Technologies Mécaniques"> Sciences et Technologies Mécaniques </option>
	                            ...
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="mt">
	                                            <option disabled="disabled" selected="selected">  Mention du bac</option>
	              ...
	              <option value="passable"> passable </option>
	                        ...
	                        <div class="row row-space">
	                            <div class="col-2">
	                                <div class="input-group">
	                                    <input class="input--style-2" type="text" placeholder="Lycee du Bac" name="lycee">
	                                ...
	                                <div class="input-group">
	                                    <div class="rs-select2 js-select-simple select--no-search">
	                                        <select name="villeBac">
	                                            <option disabled="disabled" selected="selected">Ville du bac</option>
	                                             <option value=" AL HAJEB"> AL HAJEB </option>
	              <option value=" AGADIR "> AGADIR </option>
	              <option value="AL HOCEIMA "> AL HOCEIMA </option>
	              <option value="ASSA "> ASSA </option>
	              ...
	              <option value="TIZNIT"> TIZNIT </option>
	                        ...
	                        <div class="input-group">
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="acad">
	                                            <option disabled="disabled" selected="selected">  Academie</option>
	              ...
	              <option value="Tanger - Tetouan - Alhouceima"> Tanger - Tetouan - Alhouceima </option>
	                        ...
	                        <div class="input-group">
	                            <div class="rs-select2 js-select-simple select--no-search">
	                               <select name="an_Bac">
	                                            <option disabled="disabled" selected="selected">  Année d'obtention du bac</option>
	                        ...
	                        <div class="row row-space">
	                            <div class="col-2">
	                                <div class="input-group">
	                                    <div class="rs-select2 js-select-simple select--no-search">
	                                        <select name="etatPhy">
	                                            <option disabled="disabled" selected="selected">Etat physique</option>
	                                ...
	                                <div class="input-group">
	                                    <div class="rs-select2 js-select-simple select--no-search">
	                                        <select name="GroupSocio">
	                                            <option disabled="disabled" selected="selected">Groupe socioprofessionnel</option>
