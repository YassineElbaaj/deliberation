...
<head>
    ...
    <title>Liste des inscriptions en ligne</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Inscriptions administratives</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Inscriptions administratives List</h4>
                            
                            <div class="add-product">
                                <a href="/miniprojet/add-inscriptionAexcel">Ajouter une inscription depuis excel</a>
                            </div>
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <form action="supprimerAG.php" method="post"> 
                                        <td> 
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">  Supprimer les étudiants sélectionnées </button>
                            	</form>
                            </div>
