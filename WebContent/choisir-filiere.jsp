...
<head>
   <mt:head title="Choisir filiere"></mt:head>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Chosire filiere</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                             <div class="form-group">
                             	...
                             	<h2> Veuillez choisir la filière ! </h2>	                       
                                                                
                               <c:forEach items="${fil}" var="e" varStatus="loop">                                 
                              <a  href = "inscrire-etape?filiere=${e.getFiliere()}" ><button type="submit" class="btn btn-custon-rounded-three btn-success">${e.getFiliere()}</button> </a>
                               </c:forEach> 
