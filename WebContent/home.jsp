											...
											<ul class="nav navbar-nav mai-top-nav header-right-menu">
												...
												<li class="nav-item"><a href="#" data-toggle="dropdown"
													...
													class="nav-link dropdown-toggle"> <img
														src="temp2/img/product/pro4.jpg" alt="" /> <span
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
						<div class="analytics-sparkle-line reso-mg-b-30">
							<div class="analytics-content">
								<h5>Nombre d'inscription en ligne</h5>
								<h2>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="single-cards-item">
							<div class="single-product-image">
								<a href="#"><img src="temp2/img/product/profile-bg.jpg"
									alt=""></a>
							</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
							...
							<div class="single-review-st-text">
								<img src="temp2/img/notification/1.jpg" alt="">
							...
							<div class="single-review-st-text">
								<img src="temp2/img/notification/2.jpg" alt="">
								<div class="review-ctn-hf">
									<h3>Garbease sha</h3>
									<p>Awesome Pro</p>
								</div>
							...
							<div class="single-review-st-text">
								<img src="temp2/img/notification/3.jpg" alt="">
								<div class="review-ctn-hf">
									<h3>Gobetro pro</h3>
									<p>Great Website</p>
								</div>
							...
							<div class="single-review-st-text">
								<img src="temp2/img/notification/4.jpg" alt="">
								<div class="review-ctn-hf">
									<h3>Siam Graves</h3>
									<p>That's Good</p>
								</div>
							...
							<div class="single-review-st-text">
								<img src="temp2/img/notification/5.jpg" alt="">
								<div class="review-ctn-hf">
									<h3>Sarah Graves</h3>
									<p>Highly recommend</p>
								</div>
							...
							<div class="single-review-st-text">
								<img src="temp2/img/notification/6.jpg" alt="">
								<div class="review-ctn-hf">
									<h3>Julsha Grav</h3>
									<p>Sei Hoise bro</p>
								</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div
							...
							<div class="single-product-image">
								<a href="#"><img src="temp2/img/product/book-4.jpg" alt=""></a>
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div
							...
							<div class="courses-title">
								<a href="#"><img src="temp2/img/courses/1.jpg" alt="" /></a>
