...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <!-- Multi Upload Start-->
          <form  action="/miniprojet/importer-note-post" method="POST" enctype="multipart/form-data" > 
        <div class="multi-uploaded-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="alert-title dropzone-custom-sys">
                            <h2>Ajouter des notes via un fichier excel</h2>
                            <p>Veuillez ajouter le fichier Excel contenant les notes</p>
                        </div>
                    </div>
                </div>
