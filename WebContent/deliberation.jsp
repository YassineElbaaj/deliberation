...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <!-- Multi Upload Start-->
          <form  action="/miniprojet/deliberation-post" method="POST" enctype="multipart/form-data" > 
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="alert-title dropzone-custom-sys">
                            <h2>Déliberation</h2>
                            <p>Résultats du semestre: choisissez un semestre </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <select name="semestre">
                        	<option value="1">S1 et S2</option>
                        	<option value="2">S3 et S4</option>
