...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <!-- Multi Upload Start-->
          <form  action="add-inscriptionEexcel.php" method="POST" enctype="multipart/form-data" > 
        <div class="multi-uploaded-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="alert-title dropzone-custom-sys">
                            ...
                            <p>Veuillez ajouter le fichier Excel contenant les inscriptions</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input name="fichier" type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" /> 
                    </div>
        	...
        	<div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Inscrire en ligne</button>
                                                                </div>
