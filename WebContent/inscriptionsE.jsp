                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="add-product">
                                <a href="/miniprojet/add-inscriptionEexcel">Ajouter une inscription depuis excel</a>
                            </div>
                            <div class="asset-inner">
                             ...
                             <!--              <a  href = "inscriptionAd.php?massarEtud=${e.getMassarEtud()}" ><button class="btn btn-primary waves-effect waves-light"> Inscrire administrativement</button> </a>-->   
                                        ...
                                        <form action="supprimerG.php" method="post"> 
                                        <td> 
                                       
                                        
                                        <input type="checkbox" value="${e.getMassarEtud()}"  id="checkBoxAll" name="massarEtud" />
